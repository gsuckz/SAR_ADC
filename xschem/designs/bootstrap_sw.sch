...
N 790 -150 790 -130 {
lab=vss}
N 820 -150 820 -80 {lab=vout}
N 760 -150 760 -80 {lab=vout}
...
C {symbols/nfet_03v3.sym} 790 -170 3 1 {name=M7
L=0.28u
W=6u
nf=1
m=1
...
C {devices/lab_wire.sym} 790 -130 3 0 {name=p33 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 790 -190 2 0 {name=p34 sig_type=std_logic lab=clk}
